 ...
 */
final class Version20210531194957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE subscribers ADD CONSTRAINT FK_2FCD16ACA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    }
